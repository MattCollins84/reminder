<ul class="list-group dash-nav hidden-xs">
  ...
  <li class="list-group-item" id="dashboard-menu-tokens"><a href='/dashboard/tokens'><i class="fa fa-phone"></i>&nbsp;&nbsp;Purchase Tokens</a></li>
...
<ul class="list-group dash-nav dash-nav-xs visible-xs overflow">
  ...
  <li class="list-group-item pull-left br0" id="dashboard-menu-tokens-mobile"><a href='/dashboard/tokens'><i class="fa fa-phone"></i></a></li>

<ul class="list-group dash-nav hidden-xs">
  ...
  <li class="list-group-item" id="dashboard-menu-tokens"><a href='/dashboard/tokens'><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;Purchase Messages</a></li>
...
<? if (!$data['active_customer']['twitter_claim']): ?>
  <div class="alert alert-info hidden-xs">
    ...
    <p>If you have a twitter account you can get free messages!</p>
  ...
  <div class="row visible-xs">
    ...
    <div class="col-xs-6">
      <p><a href='/dashboard/twitter' class="btn btn-success btn-block"><i class="fa fa-twitter"> </i> Tweets For Messages</a></p>
    </div>
  </div>
<? else: ?>

      ...
      <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          ...
          <form class="navbar-form navbar-right visible-lg">
                          <a href="/tour/start" class="btn btn-success"><i class="fa fa-user"></i>&nbsp;&nbsp;<strong>Tour Co. Dashboard</strong> &nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-primary">485 Tokens</span></a>
  ...
  items.each(function(i) {
    ...
    <div class="col-lg-9">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Edit Dave Johnson</h3>
        </div>
        <div class="panel-body">
          <form role="form">
            

            <div class="alert alert-success mt20 hidden" id="success-container-created">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name" value="Dave Johnson" />
            </div>
            <div class="form-group">
              <label for="mobile_phone">Mobile Phone *</label>
              <input type="text" class="form-control" id="mobile_phone" name="mobile_phone" placeholder="Enter a contact phone number" value="+447767854321" />
            </div>
            <div class="form-group">
            ...
            <button type="button" class="btn btn-success"><i class="fa fa-edit"></i> Edit Contact</button>
          </form>
        </div>
      </div>
    ...
    <div class=".col-md-offset-3 col-lg-9">
      ...
      <table class="table table-striped" id="schedule-table">
        ...
        <tr>
          ...
          <td><a data-id="" id="unschedule-btn"class="btn btn-warning">Unschedule</a></td>
        </tr>
...
$(document).ready(function() {
  ...
  // Instance the tour
  tour = new Tour();
  tour.addSteps(steps.dashboardContactsEdit)

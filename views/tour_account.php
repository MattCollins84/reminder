      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form role="form">
            ...
            <p><strong>Account ID</strong><br /><span id="dashboard-account-id" class="label label-info">074003e538343cf0478cd03294833222</span></p>
            <div class="form-group">
              <label for="name">Name *</label>
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name" value="Tour Co." />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Enter a contact name" value="Tommy Tours" />
            </div>
            <div class="form-group">
              <label for="contact_phone">Contact Phone</label>
              <input type="text" class="form-control" id="contact_phone" name="contact_phone" placeholder="Enter a contact phone number" value="077313 12345" />
            </div>
            <hr />
...
<div class="container mt20">
  ...
  <div id="c">
    ...
    $(document).ready(function() {
      ...
      // Instance the tour
      tour = new Tour();
      tour.addSteps(steps.dashboardAccount)

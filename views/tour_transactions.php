      ...
      <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          ...
          <form class="navbar-form navbar-right visible-lg">
                          <a href="/tour/start" class="btn btn-success"><i class="fa fa-user"></i>&nbsp;&nbsp;<strong>Tour Co. Dashboard</strong> &nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-primary">2940 Tokens</span></a>
...
$(document).ready(function() {
  ...
  // Instance the tour
  tour = new Tour();
  tour.addSteps(steps.dashboardTransactions)
